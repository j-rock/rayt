...
main = do setupDataDirectory
  ...
  where
      ...
      redMat   = SolidColor red (RGB $ V 0.1 0 0)
      -- emissive = Emissive
      ...
      light3 = pointLight 1.0 white $ V 0 2.0 0
      light4 = areaLight 1.0 white 10 $ Rect3D (V 1.4 1 (-0.7)) (V 0 0 1) (V 0 1 0)
      light5 = areaLight 4.0 white 10 $ Rect3D (V 0.7 1 3.4) (V (-1) 0 0) (V 0 1 0)
      light6 = areaLight 10.0 white 10 $ Rect3D (V 1.4 5 (-0.7)) (V 0 0 1) (V 1 0 0)
      lts    = [
               -- light1
               -- , light2
                 -- light3
